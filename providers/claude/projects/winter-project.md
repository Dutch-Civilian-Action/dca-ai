...
Use the reviewed/merged revision for active operation. While this handover is a draft, load it deliberately as preparation and retain its pending status. Record the revision actually loaded; adding a repo link is not evidence its contents were read. Prefer current connected sources. Any one-time knowledge files are dated snapshots, not independent authority.

| Source | Purpose |
|---|---|
| [Current authority](../../../context/current-authority.md), [source routing](../../../context/source-routing.md), [workspace map](../../../context/airtable-workspace-map.md), [authority rules](../../../governance/authority-rules.md), [capability boundaries](../../../context/capability-access-boundaries.md) | Current source/authority routing, data prerequisite and action boundaries |
| [Shared Structure build](../../../context/shared-structure-build.md) and maintained Drive plan | Exact IDs, scope, source precedence, source-linked proposal and `winter-pilot-v1` capture convention |
| [Official Airtable implementation standard](https://docs.google.com/document/d/17yO7HdChXXvlxekLJjSqiHNgDWmKQm2VstpErtSJ_4c/edit?usp=drivesdk) and [Winter research usage notes](https://docs.google.com/document/d/1xJpXZyaYOpE2wALfH_YU5bUQcfUfrqF5jimNiIo8GEQ/edit) | Base guide requirements and bounded research handoff; the Winter guide is an example of use, not the general purpose of the base |
| [Relationship reconciliation](../../../workflows/reconcile-relationship-data.md) and the [packaged relationship skill](../../../plugins/dca-relationship-data/skills/managing-dca-relationship-data/SKILL.md) | Existing identity/contact intake behaviour; do not create a parallel Winter identity store |
| [Logistics intake](../../../workflows/capture-logistics-intake.md) and [validation measurement](../../../workflows/measure-validation-queue.md) | Existing evidence handoff and the distinct validation-monitor meaning |
| Architecture [development/testing/promotion](https://github.com/Dutch-Civilian-Action/dca-architecture/blob/main/systems/development-testing-and-promotion.md) and [shared structural rules](https://github.com/Dutch-Civilian-Action/dca-architecture/blob/main/systems/shared-system-structural-rules.md) | Separate test structure, data validation, runtime acceptance and production adoption |
| Kees's three readable files and explicit packing confirmation, linked in the build record | Original requirements and decisions. The newer goods-list-v2 PDF remains unread; do not present it as reconciled. |
