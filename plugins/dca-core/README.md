...
- `preserve-dca-object-boundaries` — applies DCA's organisation-wide distinctions between people, organisations, locations, contact routes, operational functions, relationships, and operational facts when evidence mixes them together.
