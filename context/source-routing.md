...
- **Contacts, organisations, partner identity or status, primary contacts, and reusable relationship context** → the current canonical Relationship Data implementation, currently `2 | DCA Relationships & Workflows`, using the Relationship Data Agent and reconciliation workflow where relevant.
