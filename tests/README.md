...
- `workflows/full-historical-domain-reconstruction.md` — standalone final synthesis, reader-usable source guide, unpublished-process-language separation, and Establish-task reuse.
...
- `workflows/reconstruction-self-evaluation-and-routing.md` — operational-validation language and role boundaries, Establish-task topology, corrected-wording confirmation, no-change closure, and validator routing.
