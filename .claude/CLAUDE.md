...
- When choosing which DCA source should answer a question, use the `route-dca-sources` skill. Its authority pointer is `context/current-authority.md`.
...
- `context/` — current AI-facing authority and source pointers
